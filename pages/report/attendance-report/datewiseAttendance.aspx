<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="datewiseAttendance.aspx.cs" Inherits="TemplatingPractice.pages.report.attendance_report.datewiseAttendance" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">Datewise Attendance Report</li>
                        </ol>
                                    ...
                                    <asp:UpdatePanel ID="upPnl" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:DropDownList ID="ddlDepartment" runat="server" title="Department List" CssClass="form-control" Enabled="false">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
