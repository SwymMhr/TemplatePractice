<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="dailyAttendance.aspx.cs" Inherits="TemplatingPractice.pages.report.attendance_report.dailyAttendance" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDateNepali" runat="server" CssClass="form-control nepaliDate1" AutoComplete="off" placeholder="Nepali Date"></asp:TextBox>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDateEnglish" runat="server" CssClass="form-control englishDate1" AutoComplete="off" placeholder="English Date"></asp:TextBox>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <asp:UpdatePanel ID="upPnl" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:DropDownList ID="ddlDepartment" runat="server" title="Department List" CssClass="form-control">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
