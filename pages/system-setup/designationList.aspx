<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="designationList.aspx.cs" Inherits="TemplatingPractice.pages.system_setup.designationList" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <div class="button-list">
                                <asp:Button ID="btnNew" runat="server" Text="+ Add New Designation" CssClass="btn btn-success col-md-3 m-b-0" OnClick="btnNew_Click" />
                            </div>
                            ...
                            <asp:GridView ID="gvDesignation" runat="server"
                                ...
                                GridLines="None"
                                EmptyDataText="No Designation found."
                                ...
                                <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="Actions">
                                         <ItemTemplate>
                                             <div class='button-list'>
                                                 <asp:LinkButton ID="lnkEdit" runat="server" CssClass="btn btn-warning w-xs waves-effect waves-light btn-xs" CommandName="editDesignation" CommandArgument='<%# Eval("DesignationID") %>'><i class='mdi mdi-pencil'></i> Edit </asp:LinkButton>
                                             </div>
                                         </ItemTemplate>
                                     </asp:TemplateField>
                                </Columns>
