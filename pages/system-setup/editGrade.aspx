<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="editGrade.aspx.cs" Inherits="TemplatingPractice.pages.system_setup.editGrade" %>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-md-12">                                    
                                   ...
                                   <div class="form-group">
                                        <label class="col-md-2 control-label">Grade Type <span class="text-danger">* </span> </label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9 col-sm-offset-2">
                                            <div class="col-md-3">
                                                <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-success col-md-12" ValidationGroup="vgGrade" OnClick="btnSave_Click" />
                                            </div>
                                            <div class="col-md-3">
